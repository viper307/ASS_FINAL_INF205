...
Public Class frmDieuchinhKH
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        Dim delquery As String = "delete from CLIENT where ID=@ID delete from Purchase where Client_id =@ID"
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim load As SqlDataAdapter = New SqlDataAdapter("select ID as 'Mã KH' ,FULL_NAME as 'Tên Khách Hàng', EMAIL from Client", conn)
